...
components:
  - name: my-quarkus-jnk
    containerImage: quay.tssc-quay/tssc/my-quarkus-jnk:abc123def456...
----
...
----
ec validate image \
  --image quay.tssc-quay/tssc/my-quarkus-jnk:abc123... \
  --policy default \
...
----
skopeo copy \
  docker://quay.tssc-quay/tssc/my-quarkus-jnk:abc123... \
