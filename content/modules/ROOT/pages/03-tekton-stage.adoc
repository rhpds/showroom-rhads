...
=== Summary
We don't need to have an empty heading for Part 5 and then a summary heading. Put a sentence here. "The following table summarizes the tasks that are executed by the pipeline."
